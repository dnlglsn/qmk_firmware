...
#define FN_SP LT(_FN, KC_SPC) // Tap for space, hold for _FN
...
XXXXXXX, XXXXXXX, XXXXXXX, KC_LCTL, KC_LGUI, LALT,    XXXXXXX, FN_SP,   XXXXXXX, XXXXXXX,		XXXXXXX, KC_SPC,  XXXXXXX, MO(_FN), ZZ_CTRL, XXXXXXX, KC_LEFT, ZZ_DOWN, KC_RGHT, XXXXXXX 
),
...
_______, _______, _______, _______, _______, _______, _______, _______, _______, XXXXXXX,		_______, _______, _______, _______, _______, _______, XXXXXXX, _______, XXXXXXX, _______,
_______, _______, _______, XXXXXXX, _______, _______, _______, _______, _______, _______,		_______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
_______, _______, _______, _______, XXXXXXX, MO(_FG), XXXXXXX, KC_SPC,  XXXXXXX, XXXXXXX,		XXXXXXX, MO(_FG), XXXXXXX, _______, _______, XXXXXXX, _______, _______, _______, _______
),
...
_______, _______, _______, KC_VOLU, KC_HOME, KC_UP,   KC_END,  KC_PGUP, _______, _______,		KC_PGUP, KC_HOME, KC_UP,   KC_END,  KC_PSCR, _______, _______, XXXXXXX, KC_F5,   _______,
_______, _______, _______, KC_VOLD, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN, _______, XXXXXXX,		KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, XXXXXXX, L_GAME,  XXXXXXX, _______,
